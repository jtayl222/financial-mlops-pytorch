...
class ABTestingDemo:
    def __init__(self, seldon_endpoint="http://ml-api.local/seldon-system", experiment_name="financial-ab-test-experiment"):
...
def main():
    ...
    parser.add_argument('--endpoint', default='http://ml-api.local/seldon-system', help='Seldon mesh endpoint (via NGINX ingress)')
